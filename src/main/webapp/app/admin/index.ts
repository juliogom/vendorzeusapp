...
export * from './references/references-management-dialog.component';
export * from './references/references.route';
export * from './references/references-modal.service';
export * from './references/product.service';

export * from './attributes/attributes.component';
export * from './attributes/attributes.route';
export * from './attributes/attribute-management-dialog.component';
export * from './attributes/attribute-modal.service';

export * from './attributes/colors/colors.component';
export * from './attributes/colors/color-modal.service';
export * from './attributes/colors/color-management-dialog.component';
export * from './attributes/colors/color.service';
export * from './attributes/sizes/sizes.component';
export * from './attributes/sizes/size-modal.service';
export * from './attributes/sizes/size-management-dialog.component';
